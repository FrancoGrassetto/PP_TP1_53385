Este proyecto implementa un sistema para la administración de Eventos Universitarios,
Salas, Actividades (Charlas y Talleres) y Estudiantes Inscriptos, aplicando los 
conceptos fundamentales del paradigma orientado a objetos en Java:
